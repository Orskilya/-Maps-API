...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.result_search.setGeometry(QtCore.QRect(135, 110, 261, 141))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.result_search.setFont(font)
        self.result_search.setText("")
        self.result_search.setWordWrap(True)
        self.result_search.setObjectName("result_search")
        self.postal_code_box = QtWidgets.QCheckBox(self.frame)
        self.postal_code_box.setGeometry(QtCore.QRect(135, 70, 261, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.postal_code_box.setFont(font)
        self.postal_code_box.setObjectName("postal_code_box")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.postal_code_box.setText(_translate("MainWindow", "Почтовый индекс"))
